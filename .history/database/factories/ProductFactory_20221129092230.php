    ...
    public function definition()
    {
        ...
        if($status == 'emergency'){
            ...
            return [
                ...
                'planner_remark' => fake()->randomElement(['This order is urgent','The order might face low stock in the middle production','Be careful with the producing']),
                'operator_remark' => fake()->randomElement(['This order is urgent','The order might face low stock in the middle production','Be careful with the producing']),
        ...
        return [
                ...
                'operator_remark' => fake()->randomElement(['The machine for the this is facing rusting problem','The order might face low stock in the middle production','Be careful with the producing']),
                'created_at' => fake()->dateTimeBetween('-6 months', 'now'),
