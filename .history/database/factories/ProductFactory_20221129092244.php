...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
                ...
                'operator_remark' => fake()->randomElement(['The machine for the this is facing rusting problem','Production is going slow because of the ','Be careful with the producing']),
                'created_at' => fake()->dateTimeBetween('-6 months', 'now'),
