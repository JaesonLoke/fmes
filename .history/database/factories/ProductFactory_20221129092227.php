...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
                ...
                'operator_remark' => fake()->randomElement(['The machine for the this is facing ','The order might face low stock in the middle production','Be careful with the producing']),
                'created_at' => fake()->dateTimeBetween('-6 months', 'now'),
