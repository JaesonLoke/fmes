...
class ProductionRecController extends Controller
{
    ...
    public function index()
    {
        ...
        $productions = Production::latest()->where('production_id', $_GET['id'])->Paginate(5);
        return view('pages.workorder.workorder',compact('productions'))->with('i',(request()->input('page',1)-1)*5);
