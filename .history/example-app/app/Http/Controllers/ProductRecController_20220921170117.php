...
class ProductRecController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $products = Product::latest()->where('workorder_id', $_GET['id'])->Paginate(5);
        return redirect()->back('product')->with('success','Product added succesfully!');
        return view('pages.product',compact('products'))->with('success','Product added succesfully!','i',(request()->input('page',1)-1)*5);
    }
