                ...
                <table class="table align-items-center table-flush" >
                  ...
                  <tbody class="list" >
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <a href="{{route('product.create')}}" class="btn btn-sm btn-neutral"><i class="fas fa-eye"></i></a>
                        <a href="{{route('product.create')}}" class="btn btn-sm btn-neutral"><i class="fas fa-pencil"></i></a>
                        <a href="{{route('product.create')}}" class="btn btn-sm btn-neutral"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
