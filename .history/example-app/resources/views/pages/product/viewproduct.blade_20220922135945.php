        ...
        <div class=" col " >
          <div class="card " >
            ...
            <div class="card-header bg-transparent">
              <div class="row m-0">
              <h4>Work Order ID: {{$work->workorder_id}}</h4>
                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="product_name" class="form-control text-center" value="{{$work->product_name}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="operator" class="form-control text-center" value="{{$work->operator_id}}" readonly/>
                        </div>
                      </div>
