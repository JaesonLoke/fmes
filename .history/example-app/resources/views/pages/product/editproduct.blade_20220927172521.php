        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Edit Product for the Order {{$product->workorder_id}}</h6>
                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="date" name="due_date" class="form-control" value="{{$product->due_date}}"/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="date" name="due_date" class="form-control" value="{{$product-><div class="row m-3">
                        <label class="col-sm-2 col-label-form">Due Date</label>
                        <div class="col-sm-8">
                          <input type="date" name="quantity" class="form-control" value="{{$product->quantity}}"/>
                        </div>
                      </div>}}"/>
                        </div>
                      </div>
