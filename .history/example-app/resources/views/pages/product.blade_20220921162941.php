            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="{{route('icons')}}">Production</a></li>
                  <li class="breadcrumb-item"><a href="{{route('workorder')}}">Work Order</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Icons</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="{{route('product.create')}}?id={{ $request->workorder_id }}" class="btn btn-sm btn-neutral"><i class="fas fa-plus"></i> New</a>
            </div>
