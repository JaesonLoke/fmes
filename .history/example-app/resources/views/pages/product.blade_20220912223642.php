                ...
                <table class="table align-items-center table-flush" >
                  ...
                  <tbody class="list" >
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <a href="{{route('product.show','$row->')}}" class="btn btn-sm btn-neutral"><i class="fas fa-eye"></i></a>
                        <a href="{{route('product.edit')}}" class="btn btn-sm btn-neutral"><i class="fas fa-edit"></i></a>
                        <a href="{{route('product.destroy')}}" class="btn btn-sm btn-neutral"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
