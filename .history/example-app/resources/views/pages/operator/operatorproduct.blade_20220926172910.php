                ...
                <table class="table align-items-center table-flush" >
                  ...
                  <tbody class="list" >
                    ...
                    <tr >
                      ...
                      <td>
                        <a href="" class="btn btn-sm btn-neutral"><i class="fas fa-info"></i></a>
                      </td>
                      <td class="text-right">
                          <a href="{{route('opearator.start',$row->id)}}" class="btn btn-sm btn-neutral"><i class="fas fa-play"></i></a>
                          <a href="" class="btn btn-sm btn-neutral"><i class="fas fa-stop"></i></a>
                          <a href="#" data-toggle="modal" data-target="#ModelDelete{{$row->id}}" class="btn btn-sm btn-danger"><i class="fas fa-exclamation-triangle "></i></a>
                      </td>
