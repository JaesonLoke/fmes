                ...
                <table class="table align-items-center table-flush">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th scope="col" class="sort" data-sort="date">Due Date</th>
                    </tr>
                  </thead>
                  <tbody class="list">
                    <tr>
                      <th scope="row">
                        <div class="media align-items-center">
                          ...
                          <div class="media-body">
                            <a href="{{ route('operator.workorder') }}" class="name mb-0 text-sm">Argon Design System</a>
                          </div>
                        </div>
                      </th>
                      <td>
                      ...
                      <td>
                        <span class="duedate">19 Sep 2021</span>
                      </td>
                    </tr>
                    <tr>
                      <th scope="row">
