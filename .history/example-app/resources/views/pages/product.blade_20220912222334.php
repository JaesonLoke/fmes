                ...
                <table class="table align-items-center table-flush" >
                  ...
                  <tbody class="list" >
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <a href="{{route('product.show')}}" class="btn btn-sm btn-neutral"><i class="fas fa-eye"></i></a>
                        <a href="{{route('product.update')}}" class="btn btn-sm btn-neutral"><i class="fas fa-edit"></i></a>
                        <a href="{{route('product.delete')}}" class="btn btn-sm btn-neutral"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
