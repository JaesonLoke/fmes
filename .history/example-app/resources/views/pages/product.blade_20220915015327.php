                  ...
                  <tbody class="list" >
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                          ...
                          <a href="{{route('product.edit',$row->id)}}" class="btn btn-sm btn-neutral"><i class="fas fa-editrasht"></i></a>
                          <button type="submit" class="btn btn-sm btn-neutral"><i class="fas fa-trash"></i></button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
