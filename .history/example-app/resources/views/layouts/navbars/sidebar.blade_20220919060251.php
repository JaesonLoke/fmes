        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{ route('logout') }}" class="nav-link bg-danger text-white align-items-end ml-auto" onclick="event.preventDefault();
                    document.getElementById('logout-form').submit();" style="padding: 0;
    margin: 0;
    background: red;
