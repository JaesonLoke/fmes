...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('production', function () {return view('pages.production');})->name('production'); 
	Route::get('table-list', function () {return view('pages.tables');})->name('table');
	
	//workorder
	Route::get('workorder', 'App\Http\Controllers\WorkRecController@index')->name('workorder');
	Route::get('creatework', 'App\Http\Controllers\ProductRecController@create')->name('product.create');
	Route::get('viewwork/{product}', 'App\Http\Controllers\ProductRecController@show')->name('product.show');
	Route::get('editwork/{product}', 'App\Http\Controllers\ProductRecController@edit')->name('product.edit');
