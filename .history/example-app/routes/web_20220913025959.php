...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::put('editproduct/{product}', 'App\Http\Controllers\ProductRecController@update')->name('product.edit');
	Route::get('deleteproduct/{product}', 'App\Http\Controllers\ProductRecController@destroy')->name('product.destroy');
