...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('createproduct', 'App\Http\Controllers\ProductRecController@create')->name('product.view');
	Route::get('createproduct', 'App\Http\Controllers\ProductRecController@create')->name('product.edit');
	Route::get('createproduct', 'App\Http\Controllers\ProductRecController@create')->name('product.destroy');
