...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('createproduct', 'App\Http\Controllers\ProductRecController@edit')->name('product.edit');
	Route::get('createproduct', 'App\Http\Controllers\ProductRecController@destroy')->name('product.destroy');
