...
Route::group(['middleware' => 'auth'], function () {
	...
	//operator production
	Route::get('operator.production', function () {return view('pages.operator.operatorproduction');})->name('operator.production');
	
	//operator workorder
	Route::get('operator.workorder', function () {return view('pages.operator.operatorworkorder');})->name('operator.workorder');
	...
	Route::delete('operator.stopproduct/{product}', 'App\Http\Controllers\OProductRecController@storefb')->name('operator.stopproduct');
	Route::get('operator.endproduct/{product}', 'App\Http\Controllers\OProductRecController@end')->name('operator.endproduct');
