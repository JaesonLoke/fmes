...
Route::group(['middleware' => ['auth','isAdmin']], function () {
	...
	Route::get('createuser', 'App\Http\Controllers\UserController@createadmin')->name('admin.create');
	Route::post('storeuser', 'App\Http\Controllers\UserController@storeadmin')->name('admin.store');
	Route::get('viewuser/{user}', 'App\Http\Controllers\UserController@viewadmin')->name('admin.view');
	Route::get('user.fetch/{id}', 'App\Http\Controllers\InventoryController@fetch_userimage')->name('user.fetch');
