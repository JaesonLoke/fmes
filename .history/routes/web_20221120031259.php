...
Route::post('operator.stopwork/{work}', 'App\Http\Controllers\OWorkRecController@stop')->name('operator.stopwork');
Route::get('operator.startwork/{work}', 'App\Http\Controllers\OWorkRecController@start')->name('operator.startwork');
Route::get('operatoremergency.work/{work}', 'App\Http\Controllers\OWorkRecController@emergency')->name('operatoremergency.work');
...
Route::post('operator.stopproduct/{product}', 'App\Http\Controllers\OProductRecController@stop')->name('operator.stopproduct');
Route::get('operator.endproduct/{productinfo}', 'App\Http\Controllers\OProductRecController@endindex')->name('operator.endproduct');
Route::post('operator.endproductform/{product}', 'App\Http\Controllers\OProductRecController@end')->name('operator.endproductform');
Route::get('operatoremergency.product/{product}', 'App\Http\Controllers\OProductRecController@emergency')->name('operatoremergency.product');


Route::resource('user', 'App\Http\Controllers\UserController', ['except' => ['show']]);

Route::get('profile', ['as' => 'profile.edit', 'uses' => 'App\Http\Controllers\ProfileController@edit']);
Route::get('operator.edit', ['as' => 'operator.edit', 'uses' => 'App\Http\Controllers\ProfileController@operatoredit']);

Route::put('profile', ['as' => 'profile.update', 'uses' => 'App\Http\Controllers\ProfileController@update']);
Route::put('profile.detail', ['as' => 'profile.detail', 'uses' => 'App\Http\Controllers\ProfileController@detail']);
Route::post('profile.pic', 'App\Http\Controllers\ProfileController@pic')->name('profile.pic');
Route::put('profile/password', ['as' => 'profile.password', 
								'uses' => 'App\Http\Controllers\ProfileController@password']);
								
Route::get('updateinventory', 'App\Http\Controllers\InventoryController@endinventoryindex')->name('updateinventory');
Route::get('fetch/{id}', 'App\Http\Controllers\InventoryController@fetch_image')->name('inventory.fetch');

Route::get('viewoperator/{user}', 'App\Http\Controllers\UserController@operatorviewadmin')->name('operator.view');
Route::get('user.fetch/{id}', 'App\Http\Controllers\UserController@fetch_image')->name('user.fetch');
});