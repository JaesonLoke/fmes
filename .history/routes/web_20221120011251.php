...
Route::delete('operator.stopproduction/{production}', 'App\Http\Controllers\OProductionRecController@stop')->name('operator.stopproduction');
Route::get('operator.startproduction/{production}', 'App\Http\Controllers\OProductionRecController@start')->name('operator.startproduction');
