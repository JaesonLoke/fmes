...
Route::get('operator.endproduct/{product}', 'App\Http\Controllers\OProductRecController@endindex')->name('operator.endproduct');
Route::post('operator.endproductform/{product}', 'App\Http\Controllers\OProductRecController@endindex)->name('operator.endproduct');
