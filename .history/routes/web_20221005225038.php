...
Route::group(['middleware' => ['auth','isAdmin']], function () {
	...
	Route::get('createuser', 'App\Http\Controllers\UserController@create')->name('admin.create');
	Route::post('storeuser', 'App\Http\Controllers\UserController@store')->name('admin.store');
	Route::get('viewuser/{user}', 'App\Http\Controllers\UserController@create')->name('admin.create');
