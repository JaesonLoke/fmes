...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('createinventory', 'App\Http\Controllers\InventoryController@create')->name('inventory.inventory');
	Route::post('storeinventoryt', 'App\Http\Controllers\ProductRecController@store')->name('inventory.store');
