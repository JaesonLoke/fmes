...
Route::post('profile.pic', 'App\Http\Controllers\ProfileController@store')->name('profile.pic');
Route::put('profile.pic', ['as' => 'profile.pic', 'uses' => 'App\Http\Controllers\ProfileController@pic']);
