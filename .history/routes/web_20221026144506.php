...
Route::get('profile.edit', ['as' => 'profile.edit', 'uses' => 'App\Http\Controllers\ProfileController@edit'])->name('profile.edit');
Route::get('operator.edit', ['as' => 'profile.edit', 'uses' => 'App\Http\Controllers\ProfileController@operatoredit'])->name('operator.edit');
...
Route::get('viewuser/{user}', 'App\Http\Controllers\UserController@operatorviewadmin')->name('operator.view');
	Route::get('user.fetch/{id}', 'App\Http\Controllers\UserController@fetch_image')->name('user.fetch');
});