                        ...
                        <form method="post" action="{{ route('profile.detail') }}" >
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('contactnum') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-contactnum">{{ __('contactnum') }}</label>
                                    <input type="text" name="contactnum" id="input-contactnum" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Name') }}" value="{{ old('name', auth()->user()->name) }}" required autofocus>
