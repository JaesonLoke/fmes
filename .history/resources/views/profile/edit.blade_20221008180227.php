                        ...
                        <form method="post" action="{{ route('profile.detail') }}" >
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('desc') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea  name="desc" id="input-desc" class="form-control form-control-alternative{{ $errors->has('desc') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}" value="{{ old('desc', auth()->user()->desc) }}" required></textarea>
