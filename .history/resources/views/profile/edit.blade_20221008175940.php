                        ...
                        <form method="post" action="{{ route('profile.detail') }}" >
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('position') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="position" id="input-position" class="form-control form-control-alternative{{ $errors->has('pos') ? ' is-invalid' : '' }}" placeholder="{{ __('Position') }}" value="{{ old('pos', auth()->user()->pos) }}" required autofocus>
