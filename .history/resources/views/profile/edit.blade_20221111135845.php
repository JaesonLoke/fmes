@extends('layouts.app', ['title' => __('User Profile'),'class' => 'bg-dark'])
                        ...
                        <form method="post" action="{{ route('profile.detail') }}" >
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('contactnum') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="phonenum" name="contactnum" id="input-contactnum" class="form-control form-control-alternative{{ $errors->has('contactnum') ? ' is-invalid' : '' }}" placeholder="{{ __('Contact Number') }}" value="{{ old('name', auth()->user()->contactnum) }}" required autofocus>
