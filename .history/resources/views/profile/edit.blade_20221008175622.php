                        ...
                        <form method="post" action="{{ route('profile.detail') }}" >
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('pos') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-pos">{{ __('Position') }}</label>
                                    <input type="text" name="fullname" id="input-pos" class="form-control form-control-alternative{{ $errors->has('fullname') ? ' is-invalid' : '' }}" placeholder="{{ __('Fullname') }}" value="{{ old('fullname', auth()->user()->fullname) }}" required autofocus>
