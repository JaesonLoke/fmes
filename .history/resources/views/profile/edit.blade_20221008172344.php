                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('fullname') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="fullname" id="input-name" class="form-control form-control-alternative{{ $errors->has('fullname') ? ' is-invalid' : '' }}" placeholder="{{ __('Fullname') }}" value="{{ old('fullname', auth()->user()->name) }}" required autofocus>
