                ...
                <div class="card card-profile shadow">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src=" @if (auth()->user()->image !=null) {{route('user.fetch',auth()->user()->id)}}  @else {{ asset('argon') }}/img/theme/team-4-800x800.jpg  @endif " class="rounded-circle" height=180px width="auto">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-150 pt-md-10">
                        <div class="text-center">
                            ...
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ auth()->user()->desc }}
                            </div>
                            <div>
