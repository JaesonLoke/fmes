                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src=" @if (auth()->user()->image !=null) {{route('user.fetch',auth()->user()->id)}}  @else {{ asset('argon') }}/img/theme/team-4-800x800.jpg  @endif " class="rounded-circle" height=200px wei>
                                </a>
                            </div>
                        </div>
                    </div>
