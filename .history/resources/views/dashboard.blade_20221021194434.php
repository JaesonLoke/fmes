                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0">{{$avaibility}}%</span>
                                </div>
                                <div class="col-auto">
                            ...
                            <p class="mt-3 mb-0 text-muted text-sm">
                                <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> {{$avaibilitycompare}}%</span>
            ...
            <div class="col-xl-4">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <!-- Chart -->
                        <div class="chart">
                            <canvas id="dashboard-chart" class="chart-canvas"></canvas>
                        </div>
                    </div>
                </div>
            </div>
