                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="status" class="form-control text-center bg-white" value="{{$product->status}}" readonly/>
                        </div>

                        <label class="col-sm-2 col-label-form">Completion</label>
                        <div class="col-sm-3">
                          <input type="text" name="com" class="form-control text-center bg-white" value="{{$product->completion}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="operator" class="form-control text-center bg-white" value="{{$product->operator_id}}" readonly/>
                        </div>
