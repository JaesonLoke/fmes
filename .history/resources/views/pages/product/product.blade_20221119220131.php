                    ...
                    <tr>
                      ...
                      <td>
                        <Form action="{{route('product.destroy',$row->id)}}" method="post" enctype="multipart/form-data">
                          ...
                          @method('DELETE')
                          @csrf
                          <button type="submit"  class="btn btn-sm btn-danger" onclick="return confirm('{{ __('Are you sure you want to delete?') }}')" href="{{route('product.destroy',$row->id)}}"><i class="fas fa-trash"></i></a>
                          </Form>
                      </td>
