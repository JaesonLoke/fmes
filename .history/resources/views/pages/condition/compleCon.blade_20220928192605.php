...
@if ($row['status'] == 'delayed' || $row['status'] == 'pending' || $row['status'] == 'emergency' )  
      ...
      <div class="progress">
        ...
        aria-valuenow="{{$value == 1 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{$value}}%;"></div>
      </div>
...
@elseif ($row['status'] == 'completed' || $row['status'] == 'new' || $row['status'] == 'Running')  
      ...
      <div class="progress">
        ...
        aria-valuenow="{{ echo $value == 1 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{$value}}%;"></div>
      </div>
