    ...
    @if ($row['status'] == 'delayed' || $row['status'] == 'pending' || date("Y-m-d") >= Carbon\Carbon::parse($row['due_date'])->subDays(2)  )  
    ...
    @elseif ( date("Y-m-d") >= Carbon\Carbon::parse($row['due_date'])->subDays(5))
