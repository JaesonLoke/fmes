@if (date("Y-m-d") >= Carbon\Carbon::parse($row['due_date']) )  
<span class='badge badge-pill badge-danger'>Overdue</span>

@elseif (date("Y-m-d") >= Carbon\Carbon::parse($row['due_date'])->subDays(2) )  
<span class='badge badge-pill badge-danger'>Due Soon</span>
