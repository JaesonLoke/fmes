            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item text-primary"><a href="#"><i class="fas fa-home"></i></a></li>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="avatar-group">
                          <a href="{{route('admin.view',$row->planner_id) }}" class="avatar avatar-sm rounded-circle" data-toggle="tooltip" data-original-title="{{DB::table('users')->where('id',$work->planner_id)->value('fullname')}}">
