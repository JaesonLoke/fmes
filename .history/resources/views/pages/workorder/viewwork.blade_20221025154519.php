                ...
                <table class="table align-items-center table-flush " >
                  <thead class="thead-light">
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="product_name" class="form-control text-center bg-white text-dark" value="{{$work->workorder_name}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="date" name="due_date" class="form-control text-center bg-white text-dark" value="{{$work->due_date}}" readonly/>
                        </div>

                        <label class="col-sm-2 col-label-form">Created Date</label>
                        <div class="col-sm-3">
                          <input type="date" name="createdate" class="form-control text-center bg-white text-dark" value="{{$work->created_at->toDateString()}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3 text-center" >
                          @include('pages.condition.viewworkstatus')
                        </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <textarea name="remark" class="form-control text-center bg-white text-dark" value="{{$work->operator_id}}" readonly></textarea>
                        </div>
                      </div>
