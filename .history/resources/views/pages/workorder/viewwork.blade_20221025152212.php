                ...
                <table class="table align-items-center table-flush " >
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="status" class="form-control text-center text-dark" value="{{$work->status}}" readonly/>
                        </div>

                        <label class="col-sm-2 col-label-form">Planner</label>
                        <div class="col-sm-3">
                          <input type="text" name="operator" class="form-control text-center text-dark" value="{{DB::table('users')->where('id',$work->planner_id)->value('')}}" readonly/>
                        </div>
                      </div>
