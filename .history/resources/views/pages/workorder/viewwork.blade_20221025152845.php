                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <div class="avatar-group">
                            <a href="{{route('admin.view',$work->planner_id) }}" class="avatar avatar-sm rounded-circle" data-toggle="tooltip" data-original-title="{{$work->planner_id}}">
                              <img alt="Image placeholder" src="{{route('user.fetch', $work->planner_id)}}">
                            </a>
                          </div>
                          <span type="text" name="operator" class="form-control text-center text-dark" value="{{DB::table('users')->where('id',$work->planner_id)->value('fullname')}}" readonly/>
                        </div>
                      </div>
