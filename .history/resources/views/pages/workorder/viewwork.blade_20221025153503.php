                  ...
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3 text-center">
                          <span class='badge badge-pill badge-dark' style="width:200px; height:30px"> {{$work->due_date}} </span>
                        </div>

                        <label class="col-sm-2 col-label-form">Created Date</label>
                        <div class="col-sm-3 text-center">
                          <span class='badge badge-pill badge-dark' style="width:200px; height:30px"> {{$work->created_at->toDateString()}} </span>
                        </div>
                      </div>
