                    ...
                    <tr>
                      ...
                      <td>
                        <div class="avatar-group">
                          <a href="{{route('admin.view',$row->planner_id) }}" class="avatar avatar-sm rounded-circle" 
                            data-toggle="tooltip" data-original-title="{{DB::table('users')->where('id',$row->planner_id)->value('fullname')}}">
                      ...
                      <td >
                        <Form action="{{route('work.destroy',$row->id)}}" method="post" enctype="multipart/form-data">
                          ...
                          href="{{route('product.destroy',$row->id)}}"><i class="fas fa-trash"></i></a>
                          </Form>
                    </tr>
                    @endforeach
                    @endif
