...
<div class="card">
    ...
    <div class="card-body text-center">
        <form action="{{route('operator.endproductform',$productinfo->id)}}" method="POST">
            ...
            <div class="row">
                <span class="col-sm">Product: </span><span class="font-weight-bold">{{$productinfo->product_name}}</span></div><br>

            <div class="row">
                <span class="col-sm ">Current Quantity: </span><span class="font-weight-bold">{{$productinfo->completion}}</span></div>

              <div class="row">
                <span class="col-sm">Requested Quantity: </span><span class="font-weight-bold">{{$productinfo->quantity}}</span></div>
