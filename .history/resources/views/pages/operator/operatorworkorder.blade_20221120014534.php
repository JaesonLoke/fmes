                  ...
                  <tbody class="list" >
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <span>{{ DB::table('products')->where('workorder_id',$row->id)->where('status','!=','completed')->count()}}</span>
                      ...
                      <td> 
                        ...
                        @if ($row->status == "emergency")
                        @else
                        <a href="{{route('operator.startwork',$row->id)}}" data-toggle="modal" data-target="#ModelEmergency{{$row->id}}" class="btn btn-sm btn-danger"><i class="fas fa-exclamation-triangle "></i></a>
                        @endif
