    ...
    <div class="card-body text-center">
        <form action="{{route('operator.endproductform',$productinfo->id)}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="row">
                <div class="col-sm">
                  <input type="number" min=1 step=1 placeholder={{$productinfo->quantity - $productinfo->completion}}  name="quantity" decimal=0 class="form-control bg-secondary text-dark" required/>
                </div>
              </div>
