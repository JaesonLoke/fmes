          ...
          <div class="card " >
            ...
            <div class="card-header bg-transparent">
              ...
              <div class="col-md-10 text-right">
                <a href="{{route('product')}}?id={{DB::table('workorders')->where('id', $_GET['id'])->value('production_id');}}" class="btn btn-sm btn-neutral"><i class="fas fa-exit"></i> Back</a>
              </div>
              </div>
            </div>
                  ...
                  <tbody class="list" >
                    ...
                    @endif
                      ...
                      <td> 
                        ...
                        @if ($row->status == "new")
                      @else
                      <a href="#" data-toggle="modal" data-target="#ModelEnd{{$row->id}}" class="btn btn-sm btn-neutral"><i class="fas fa-stop"></i></a>
                      @endif
