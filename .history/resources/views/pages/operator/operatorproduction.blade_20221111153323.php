            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="{{route('operator')}}"><i class="fas fa-home"></i></a></li>
                ...
                <table class="table align-items-center table-flush data-table" >
                  ...
                  <tbody class="list" >
                    ...
                    @endif
                      ...
                      <td> 
                        @if ($row->status == "emergency")
                        <a href="{{route('operator.startwork',$row->id)}}" class="btn btn-sm btn-neutral">
                        ...
                        @if ($row->status == "emergency")
                        @else
                        <a href="#" data-toggle="modal" data-target="#ModelEmergency{{$row->id}}" 
                          class="btn btn-sm btn-danger"><i class="fas fa-exclamation-triangle "></i></a>
                        @endif
