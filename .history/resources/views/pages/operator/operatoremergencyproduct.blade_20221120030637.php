              ...
              <div class="card-header bg-transparent">
                <div class="row m-0">
                  ...
                  <div class="col-md-10 text-right">
                    <a href="{{ url()->previous() }}" class="btn btn-sm btn-neutral"><i class="fas fa-exit"></i> Back</a>
                  </div>
                </div>
              </div>
                <div class="table-responsive bg-secondary"  >
                  <table class="table align-items-center table-flush bg-secondary" >
                    <thead class="thead-light">
                      ...
                      <form method="POST" action="{{route('operator.stopproduct',$product->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row m-3">
                          <label class="col-sm-2 col-label-form">Reason for the stop:</label>
                          <div class="col-sm-8">
                            <textarea type="text" name="reason" class="form-control" rows="5" required></textarea>
                          </div>
                        </div>
