...
<div class="card">
    <div class="card-header">
        ...
        <div class="col-md-10 text-right">
            <a href="{{route('operator.endproduct/{productinfo}')}}?id={{DB::table('workorders')->where('id', $_GET['id'])->value('production_id');}}" class="btn btn-sm btn-neutral"><i class="fas fa-exit"></i> Back</a>
          </div>
    </div>
