                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="password" name="old_password" id="input-current-password" maxlength="4" class="form-control form-control-alternative{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="{{ __('Current Password') }}" value="" required>
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="password" name="password" id="input-password" maxlength="4" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('New Password') }}" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="input-password-confirmation" maxlength="4" class="form-control form-control-alternative" placeholder="{{ __('Confirm New Password') }}" value="" required>
                                </div>
