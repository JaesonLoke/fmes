    ...
    <div class="card-body text-center">
        <form action="{{route('operator.endproductform',$productinfo->id)}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="row">
                <div class="col-sm">
                  <input type="number" min=1 step=1  name="quantity" decimal=0 class="form-control bg-secondary text-black" required/>
                </div>
              </div>
              ...
              <br>
                ...
                <div class="row">
                     <label class="col col-label-form">Note:</label></div>
                        <div class="row">
                        <div class="col-sm">
                            <textarea type="text" rows="5" name="note" class="form-control bg-secondary" required>{{$productinfo->operator_remark}}</textarea>
                        </div>
                        </div>
              <br>
              <br>
