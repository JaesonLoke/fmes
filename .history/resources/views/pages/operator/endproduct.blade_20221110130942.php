    ...
    <div class="card-body text-center">
        <form action="{{route('operator.endproductform',$productinfo->id)}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="row">
                <div class="col-sm">
                  <input type="number" min=1 step=1 name="quantity" decimal=0 class="form-control bg-secondary text-dark" required/>
                </div>
              </div>
                    ...
                    <table class="table" id="inventorys_table">
                        ...
                        <tbody>
                            <tr id="inventory0">
                                ...
                                <td>
                                    <input type="number" name="quantities[]" max="{{$row->quantity}}" class="form-control" value="1" />
                                </td>
                            </tr>
                            <tr id="inventory1"></tr>
                        </tbody>
                    ...
                    <table class="table" id="inventoryswaste_table">
                        ...
                        <tbody>
                            <tr id="inventorywaste0">
                                ...
                                <td>
                                    <input type="number" name="quantitieswaste[]" max="{{$row->quantity}}" class="form-control" value="1" />
                                </td>
                            </tr>
 ...
 $(document).ready(function(){
  ...
  $(document).ready(function(){
    ...
    $("#add_rowwaste").click(function(e){
      e.preventDefault();
      let new_row_number = row_number - 1;
      $('#inventorywaste' + row_number).html($('#inventorywaste' + new_row_number)
      .html()).find('td:first-child');
