...
<div class="card">
    ...
    <div class="card-body text-center">
        <form action="{{route('operator.endproductform',$productinfo->id)}}" method="POST">
            ...
            <div class="row">
                <span class="col-sm-7 ">Product: </span><div class="font-weight-bold">{{$productinfo->product_name}}</span></div><br>

            <div class="row">
                <span class="col-sm-7 ">Current Quantity: </span><div class="font-weight-bold">{{$productinfo->completion}}</span></div>

              <div class="row">
                <span class="col-sm-7">Requested Quantity: </span><div class="font-weight-bold">{{$productinfo->quantity}}</span></div>
