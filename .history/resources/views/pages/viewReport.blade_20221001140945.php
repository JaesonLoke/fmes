        ...
        <div class=" col " >
          <div class="card " >
            ...
            <div class="card-header bg-transparent">
              <div class="row m-0">
              <h4>Report ID: {{$reports->id}}</h4>
              <div class="col-md-10 text-right">
                <a href="{{route('reporting')}}?id={{$reports->workorder_id}}" class="btn btn-sm btn-neutral"><i class="fas fa-exit"></i> Back</a>
              </div>
              </div>
            </div>
                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="date" name="createdate" class="form-control text-center" value="{{$reports->created_at}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <textarea name="remark" class="form-control text-center" value="{{$reports->operator_id}}" readonly></textarea>
                        </div>
                      </div>
