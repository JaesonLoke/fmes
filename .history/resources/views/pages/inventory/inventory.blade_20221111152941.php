                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h2 font-weight-bold mb-0 @if ($wastesum > 20) text-danger @elseif($wastesum > 50) text-warning @endif">{{$wastesum}}%</span>
                            </div>
                            <div class="col-auto">
                ...
                <table class="table align-items-center table-flush data-table">
                  ...
                  <tbody class="list">
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="name mb-0 text-sm @if ($row->quantity < 20) text-danger @endif">{{$row->quantity}}</span>
                      </td>
                      <td>
