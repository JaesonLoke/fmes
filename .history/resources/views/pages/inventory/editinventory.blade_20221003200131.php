                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('product.update',$inventory->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="inventory_name" class="form-control" value="{{$inventory->inventory_name}}"/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="number" name="quantity" class="form-control" value="{{$inventory->inventory_name}}/>
                        </div>
