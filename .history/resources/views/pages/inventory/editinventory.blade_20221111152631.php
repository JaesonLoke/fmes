        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Edit Inventory {{DB::table('inventorys')->where('id',$inventory->id)->value('inventory_name')}}</h6>
          ...
          <div class="card " >
            ...
            <div class="card-header bg-transparent">
              ...
              <div class="col text-right">
                <a href="{{route('inventory')}}" class="btn btn-sm btn-neutral"><i class="fas fa-exit"></i> Back</a>
              </div>
            </div>
            </div>
                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('inventory.update',$inventory->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="number" name="quantity" class="form-control" min="1" value="{{$inventory->quantity}}" required/>
                        </div>
