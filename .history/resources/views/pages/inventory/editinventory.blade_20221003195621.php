        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Edit Product for the Order {{$inventory->workorder_id}}</h6>
                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('product.update',$inventory->id)}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="date" name="due_date" class="form-control" value="{{$inventory->due_date}}"/>
                        </div>
                      </div>
