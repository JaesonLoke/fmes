                      ...
                      <div class="card-body">
                          <div class="row">
                              <div class="col">
                                  ...
                                  <span class="h2 font-weight-bold mb-0">{{ DB::table('notifications')->whereRaw('MONTH(created_at) = '.DATENAME(month, GETDATE()))->sum('quantity') + DB::table('reports')->sum('wastedquantity') }}</span>
                              </div>
                              <div class="col-auto">
