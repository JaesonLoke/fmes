                      ...
                      <div class="card-body">
                          <div class="row">
                              <div class="col">
                                  ...
                                  <span class="h2 font-weight-bold mb-0">{{ App\Http\Controllers\InventoryController::nFormat(DB::table('notifications')->sum('quantity') + DB::table('reports')->sum('wastedquantity') + 1000000$num)  }}</span>
                              </div>
                              <div class="col-auto">
