                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="status" class="form-control text-center" value="{{$report->report}}" readonly/>
                        </div>

                        <label class="col-sm-2 col-label-form">Reported Date</label>
                        <div class="col-sm-3">
                          <input type="date" name="com" class="form-control text-center" value="{{$report->created_at}}" readonly/>
                        </div>
                      </div>
