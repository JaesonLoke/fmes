            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            <label class="col-sm-7 col-label-form">Current Quantity: {{$row->completion}}</label></div>
            
                          <div class="row">
                            <label class="col-sm-7 col-label-form">Requested Quantity: {{$row->quantity}} nl2br();</label></div>
