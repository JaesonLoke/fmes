            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    ...
                    <div class="modal-body text-center">
                        <div class="row">
                            <label class="col-sm-5 col-label-form">Current Quantity: {{$row->completion}}</label></div>
            
                          <div class="row m-10">
                            <label class="col-sm-5 col-label-form">Requested Quantity: {{$row->quantity}}</label></div>
