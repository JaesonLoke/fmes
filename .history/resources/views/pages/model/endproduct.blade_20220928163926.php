            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            <label class="col-sm-10 ">Current Quantity: <div class="font-weight-bold">{{$row->completion}} </div></label></div>
            
                          <div class="row">
                            <label class="col-sm-10">Requested Quantity: <div class="font-weight-bold">{{$row->quantity}}</div></label></div>
