    ...
    <div class="modal fade" id="ModelEmergency{{$row->id}}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">This is only for emergency cases. Are u sure? <br><br>

                    <label class="col-sm-4 col-label-form text-center">Reason</label>
                        <div class="col-sm-12">
                          <textarea type="longtext" name="reason" class="form-control" required></textarea>
                        </div>
                </div>
