            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            <label class="col-sm-7 col-label-form">Current Quantity: <div class="font-weight-bold">{{$row->completion}} </div></label></div>
            
                          <div class="row">
                            <label class="col-sm-7 col-label-form">Requested Quantity: <div class="font-weight-bold">{{$row->quantity}}</div></label></div>
