                ...
                <div class="modal-header bg-primary">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            ...
                            <div class="row m-10">
                            <div class="col-sm-12">
                              <textarea type="text" name="note" class="form-control text-black" readonly>{{$row->planner_remark}}</textarea>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="row m-10">
                            <div class="col-sm-12">
                              <textarea type="text" name="note" class="form-control text-black" readonly>{{$row->operator_remark}}</textarea>
                            </div>
                          </div>
