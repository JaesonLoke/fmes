            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            <span class="col-sm-10 ">Current Quantity: <div class="font-weight-bold" value="{{$row->completion}}"</div></span></div>
            
                          <div class="row">
                            <span class="col-sm-10">Requested Quantity: <div class="font-weight-bold">{{$row->quantity}}</div></span></div>
