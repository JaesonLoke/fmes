                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="date" name="createdate" class="form-control text-center" value="{{$report->created_at->toDateString()}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <textarea name="remark" class="form-control text-center" value="{{$report->detail}}" readonly></textarea>
                        </div>
                      </div>
