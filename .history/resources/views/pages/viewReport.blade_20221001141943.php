                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="due_date" class="form-control text-center" value="{{$report->WorkID}}" readonly/>
                        </div>

                        <label class="col-sm-2 col-label-form">Product ID</label>
                        <div class="col-sm-3">
                          <input type="text" name="createdate" class="form-control text-center" value="{{$report->ProductID}}" readonly/>
                        </div>
                      </div>
