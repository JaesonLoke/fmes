                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <input type="text"  class="form-control text-center" value="{{$report->category}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="text"  class="form-control text-center" value="{{$report->ReporterID}}" readonly/>
                        </div>

                        <label class="col-sm-2 col-label-form">Reported Date</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control text-center" value="{{$report->created_at}}" readonly/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control text-center" value="{{$report->detail}}" readonly/>
                        </div>
                      </div>
