                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <div class="avatar-group text-center">
                            <a href="{{route('admin.view',$report->reporter_id) }}" class="avatar avatar-sm rounded-circle" data-toggle="tooltip" data-original-title="{{DB::table('users')->where('id',$report->reporter_id)->value('fullname')}}">
                              <img alt="Image placeholder" src="{{route('user.fetch', $report->reporter_id)}}">
                            </a>
                          </div>                        </div>
