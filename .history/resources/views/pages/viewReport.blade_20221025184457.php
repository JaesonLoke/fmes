                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <input type="text"  class="form-control text-center bg-white text-dark" value="{{DB::table('workorders')->where('id',$report->WorkID)->value('name')$report->category}}" readonly/>
                        </div>
                      </div>
