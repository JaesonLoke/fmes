                ...
                <table class="table align-items-center table-flush" >
                  <thead class="thead-light">
                      ...
                      <div class="row m-3">
                        ...
                        <label class="col-sm-2">Completion</label>
                        <div class="col-sm-2">
                          <div class="progress">
                            <div class="progress-bar bg-success" role="progressbar" 
                              aria-valuenow="{{$value = DB::table('products')->select(DB::raw('AVG(completion/quantity) as total'))->where('workorder_id','1')->value("total")*100  }}"  
                              aria-valuemin="0" aria-valuemax="100" style="width: {{round($value,0)}}%; ">
                            </div>
                          </div>    
                          <span class="completion"> {{round($value,0)}}%</span>           
                        </div>
                      </div>
