          ...
          <div class="card card-profile shadow">
              ...
              <div class="card-body pt-0 pt-md-4">
                  <div class="text-center">
                      ...
                      <hr class="my-4" />
                      <div class="h3 ">@if ($user->contactnum != null) Phone Num: <div class="text-primary font-weight-bold"> {{{ $user->contactnum }}} </div> @endif</div><br>
                      <div class="h3 font-weight-bold">@if ($user->email != null) Email: <div class="text-primar "> {{{ $user->email }}} </div> @endif</div>
