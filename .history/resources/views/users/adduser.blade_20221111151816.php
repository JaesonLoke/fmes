                        ...
                        <div class="card-body">
                            <div class="row mb-0">
                                <div class="col">
                                    ...
                                    <span class="h1 font-weight-bold mb-5 @if ($performance > 20) text-danger @elseif($performance > 50) text-warning @endif">{{$performance}}%</span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="card shadow ">
                    <div class="card-header bg-dark  ">
                        <div class="row align-items-center">
                            <div class="col-8 ">
                                <h3 class="text-white">Planners</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{route('admin.create')}}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add Planner</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow ">
                    <div class="card-header ">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{route('user.create')}}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add Operator</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive p-3">
                        <table class="table align-items-center data-table table-flush" >
