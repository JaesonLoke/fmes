          ...
          <div class="card card-profile shadow">
              <div class="row justify-content-center">
                  <div class="col-lg-3 order-lg-2">
                      <div class="card-profile-image">
                          <a href="#">
                              <img src="{{route('user.fetch',$user->id)}}" class="rounded-circle">
                          </a>
                      </div>
                  </div>
              </div>
              ...
              <div class="card-body pt-0 pt-md-4">
                  <div class="text-center">
                      ...
                      <div class="h3 mt-4">
                          <i class="ni business_briefcase-24 mr-2"></i>@if ($user->position != null) {{{$user->position }}} @else <div class="text-weight-light">Position</div> @endif
                      </div>
                      <hr class="my-4" />
