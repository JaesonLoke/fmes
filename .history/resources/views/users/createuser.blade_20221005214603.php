                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="password" name="email" class="form-control" placeholder="huang@gmail.com" required/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="tel" name="password" class="form-control" placeholder="019-441 1922" required/>
                        </div>
                      </div>
