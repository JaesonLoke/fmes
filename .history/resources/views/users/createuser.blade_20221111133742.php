    ...
    <div class="header bg-primary pb-6 pt-md-6" >
      <div class="container-fluid">
        <div class="header-body">
          ...
          <h6 class="h1 text-white d-inline-block mb-0">Add New Opearator</h6>
                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2 text-right">
                          <input id="password" type="password" maxlength="4" class="text-dark form-control @error('password') is-invalid @enderror" name="password" minlength="4" maxlength="4" autocomplete="current-password" placeholder="xxxx" class="text-dark form-control" required/>
                          <span class="font-weight-light h5">4 numbers only</span>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2 text-right">
                          <input id="password" type="password" maxlength="4" class="text-dark form-control @error('password') is-invalid @enderror" name="password_confirmation" minlength="4" maxlength="4" autocomplete="current-password" placeholder="xxxx" class="text-dark form-control" required/>
                          <span class="font-weight-light h5">Must same as pin!</span>
                        </div>
                      </div>
