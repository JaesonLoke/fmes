                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2 text-right">
                          <input id="password" type="password" maxlength="4" class="text-dark form-control @error('password') is-invalid @enderror" name="password" minlength="" autocomplete="current-password" placeholder="xxxx" class="text-dark form-control" required/>
