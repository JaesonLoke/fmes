                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-5">
                          <input type="text" name="fullname" class="text-dark form-control" placeholder="Loke Chung Huang" required/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2">
                          <input type="text" name="username" class="text-dark form-control" placeholder="Jaeson"  required/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2">
                          <input id="password" type="password" maxlength="4" class="text-dark form-control @error('password') is-invalid @enderror" name="password" autocomplete="current-password" class="text-dark form-control" required/>
                          <span class="font-weight-light">4 numbers</span>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2">
                          <input id="password" type="password" maxlength="4" class="text-dark form-control @error('password') is-invalid @enderror" name="password_confirmation" autocomplete="current-password" class="text-dark form-control" required/>
                          <span class="font-weight-light">Must same as pin!</span>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="email" name="email" class="text-dark form-control" placeholder="huang@gmail.com" required/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="tel" name="phonenum" class="text-dark form-control" placeholder="019-441 1922" required/>
                        </div>
                      </div>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input type="file" name="image" class="text-dark form-control"  height=500px/>
                        </div>
                      </div>
