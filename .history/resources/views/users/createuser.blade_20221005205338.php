                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-8">
                          <textarea type="text" name="desc" class="form-control" rowplaceholder="Ryan — the name taken by Melbourne-raised, Brooklyn-based Nick Murphy — writes, performs and records all of his own music." > </textarea>
                        </div>
                      </div>
