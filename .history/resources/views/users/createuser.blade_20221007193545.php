                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2">
                          <input id="password" type="password" maxlength="4" class="text-dark form-control @error('password') is-invalid @enderror" name="password" autocomplete="current-password" class="form-control" required/>
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2">
                          <input id="password" type="password" maxlength="4" class="form-control @error('password') is-invalid @enderror" name="password_confirmation" autocomplete="current-password" class="form-control" required/>
