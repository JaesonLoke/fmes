          ...
          <div class="card card-profile shadow">
              <div class="row justify-content-center">
                  <div class="col-lg-3 order-lg-2">
                      <div class="card-profile-image">
                          <a >
                              <img src=" @if ($user->image !=null) {{route('user.fetch',$user->id)}}  @else {{ asset('argon') }}/img/theme/team-4-800x800.jpg  @endif " class="rounded-circle" height="150px" width="auto">
                          </a>
                      </div>
                  </div>
              </div>
              ...
              <div class="card-body pt-0 pt-md-4">
                  <div class="text-center">
                      ...
                      <hr class="my-4" />
                      <div class="h3 font-weight-bold">@if ($user->contactnum != null) Phone Num: <div class="text-primary"> {{{ $user->contactnum }}} </div> @endif</div><br>
                      <div class="h3 font-weight-bold">@if ($user->email != null) Email: <div class="text-primary"> {{{ $user->email }}} </div> @endif</div>
