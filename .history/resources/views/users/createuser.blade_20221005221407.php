                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-3">
                          <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password_confirmation" autocomplete="current-password" class="form-control" placeholder="Loke Chung Huang" required/>
                        </div>
                      </div>
