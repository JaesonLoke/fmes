                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-2">
                        ...
                        <div class="col-sm-3">
                          <input id="password" type="pin" maxlength="4"  class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="current-password" class="form-control" required/>
