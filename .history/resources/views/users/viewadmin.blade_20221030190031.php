          ...
          <div class="card card-profile shadow">
              ...
              <div class="card-body pt-0 pt-md-4">
                  <div class="text-center">
                      ...
                      <div class="h3 ">@if ($user->email != null) Email: <div class="text-primary font-weight-bold"> {{{ $user->email }}} </div> @endif</div>

                      <hr class="my-4" />
                      <div class="col-lg-9" >
                      <p class="text-center">@if ($user->desc != null) {{{ $user->desc }}} @else No Description. @endif</p>
                      </div>
                  </div>
              </div>
          </div>
