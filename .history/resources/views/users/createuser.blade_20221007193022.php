                  ...
                  <thead class="thead-light">
                    ...
                    <form method="POST" action="{{route('user.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row m-3">
                        ...
                        <div class="col-sm-2">
                          <input id="password" type="password" maxlength="4" class="form-control-focus @error('password') is-invalid @enderror" name="password" autocomplete="current-password" class="form-control" required/>
