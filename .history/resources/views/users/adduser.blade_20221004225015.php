...
<body class="clickup-chrome-ext_installed bg-dark">

    <!-- Sidenav -->
    @include('layouts.headers.headernav')
                    ...
                    <div class="card-header border-0 bg-dark ">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="" class="btn btn-sm btn-primary">Add Admin</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @if (count($users) == 0)
                                    ...
                                    <tr>
                                        <td>{{$row->name}}</td>
                                        <td>
                                            <a href="mailto:admin@argon.com">{{$row->email}}</a>
                                        </td>
                ...
                <div class="card shadow bg-white">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush ">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td>Loke Chung Huang</td>
                                        <td>
                                            <a href="mailto:admin@argon.com">huang@gmail.com</a>
                                        </td>
                                        <td>12/02/2020 11:00</td>
                                        <td class="text-right">
                                            <div class="dropdown">
