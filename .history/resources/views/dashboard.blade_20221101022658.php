                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h1 font-weight-bold mb-0 @if ($oee < 20) text-danger @elseif($oee < 50) text-warning @endif ">{{$oee}}%</span>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class="text-white mb-0">Total Orders</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class="mb-0 text-white">Inventory Usage</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="table-responsive  ">
                        ...
                        <table class="table align-items-center table-flush text-center">
                            ...
                            <tbody class="list text-center">
                              ...
                              <tr>
                                <td class="name text-sm" style="width: 16.66%">{{ $row['category'] }}</td>
                                <td class="name text-sm" style="width: 16.66%">
