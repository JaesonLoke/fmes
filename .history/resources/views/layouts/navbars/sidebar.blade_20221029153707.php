          ...
          <ul class="navbar-nav ">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                    ...
                    <span class="nav-link-text text-primary" >{{ __('User') }}</span>
                </a>

                <div class="collapse {{ Route::is('profile.edit') ? 'show' : '' }} {{ Route::is('user.index') ? 'show' : '' }}" id="navbar-examples">
              ...
              <li class="nav-item">
                <a class="nav-link {{ Route::is('reporting') ? 'active' : '' }}" href="{{ route('reporting') }}">
                  <i class="fas fa-file" style="color: #f4645f;"></i> Reporting
                </a>
              </li>

              <li class="nav-item">
                <a class="nav-link {{ Route::is('reporting') ? 'active' : '' }}" href="{{ route('operator.production') }}">
                  <i class="fas fa-wrench" ></i> Operator Portal
                </a>
              </li>
