                    ...
                    <div class="col ml--2">
                      <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right text-muted">
                          <small>
                            @if (carbon\Carbon::parse($row->created_at)->diffInMinutes(carbon\Carbon::now()) < 60)
                              
                            {{carbon\Carbon::parse($row->created_at)->diffInMinutes(carbon\Carbon::now())}} Mintunes Ago
