...
<nav class="navbar navbar-top navbar-expand-md navbar-dark bg-primary" id="navbar-main">
  <div class="container-fluid">
      ...
      <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('home') }}">{{ __(url()->current()) }}</a>
      @else
      <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">{{url()->current()}}</a>
      @endif
