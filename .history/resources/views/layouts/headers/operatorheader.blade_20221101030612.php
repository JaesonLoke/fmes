...
<nav class="navbar navbar-top navbar-expand-md navbar-dark bg-dark" id="navbar-main">
  <div class="container-fluid">
      <!-- Brand -->
      <a href="{{route('home')}}" class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" >{{ __('F-MES Dashboard') }}</a>
      ...
      <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
            ...
            $notifications = Notification::orderby('id','desc')->simplePaginate(5);
            ?>
          ...
          <li class="nav-item dropdown">
              <a class="nav-link pr-0" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="media align-items-center">
                      <span class="avatar avatar-sm rounded-circle">
                        ...
                        <img alt="Image placeholder" src="../assets/img/theme/team-1.jpg" class="avatar avatar-sm rounded-circle">
                        @else
                        <img src="{{route('user.fetch',auth()->user()->id)}}" class="avatar avatar-sm rounded-circle">
                        @endif
                      </span>
              ...
              <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                  ...
                  <a href="{{ route('operator.edit') }}" class="dropdown-item">
