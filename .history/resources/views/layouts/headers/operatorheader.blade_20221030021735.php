...
<nav class="navbar navbar-top navbar-expand-md navbar-dark bg-dark" id="navbar-main">
  <div class="container-fluid">
      <!-- Brand -->
      <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" >{{ __('F-MES Dashboard') }}</a>
              ...
              <a class="nav-link pr-0" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="media align-items-center">
                      <span class="avatar avatar-sm rounded-circle">
                        ...
                        @else
                        <img src="{{route('user.fetch',$imgid)}}" class="avatar avatar-sm rounded-circle">
                        @endif
                      </span>
