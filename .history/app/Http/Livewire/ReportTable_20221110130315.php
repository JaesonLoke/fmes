    ...
    public function builder()
{
    ...
    ->leftjoin('users','reports.ReporterID', 'users.id');
}
    ...
    function columns()
    {
    	return [
            ...
            Column::name('users.fullname')->label('Reported by'),
    		DateColumn::name('created_at')->label('Date reported')->filterable('month'),
			Column::callback('id', function ($value) {
                return "<a class='btn btn-sm ' href='viewreporting/$value' 
                srole='button'><i class='fas fa-eye'></i></a>";
