...
{
    return $model = Report::query()->leftjoin('workorders','reports.WorkID', 'workorders.id')->leftjoin('products','reports.ProductID', 'products.id');
}
    ...
    function columns()
    {
    	return [
            ...
            Column::name('workorders.work')->label('Work Order'),
