...
class OWorkRecController extends Controller
{
    ...
    public function index()
    {
        ...
        $works = Product::latest()->where('workorder_id', $_GET['id'])->Where('status', '!=', 'completed')->Paginate(5);
        return view('pages.operator.operatorproduct',compact('works'))->with('i',(request()->input('page',1)-1)*5);
