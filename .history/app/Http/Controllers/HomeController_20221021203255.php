...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $qualitythismonth = Notification::sum('quantity') + Report::sum('wastedquantity');

        $qualitysum = Notification::sum('quantity') / $sum ;
        ...
        return view('dashboard',compact('products','reports','labels', 'data','avaibility','performance','quality'))->with('i',(request()->input('page',1)-1)*5);
    }
}
