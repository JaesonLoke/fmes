...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $lastmonth = DB::table('notifications')->whereMonth('created_at', '=', Carbon::now()->subMonth()->format('m'))->sum('quantity') + Report::whereMonth('created_at', '=', Carbon::now()->subMonth()->format('m'))->sum('wastedquantity');
