...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $sum=(DB::table('notifications')->whereMonth('created_at', '=', Carbon::now())->sum('quantity') + DB::table('reports')->whereMonth('created_at', '=', carbon\Carbon::now())->sum('wastedquantity'));
    
        $lastmonth = DB::table('notifications')->whereMonth('created_at', '=', Carbon::now()->subMonth()->format('m'))->sum('quantity') + DB::table('reports')->whereMonth('created_at', '=', carbon\Carbon::now()->subMonth()->format('m'))->sum('wastedquantity');
