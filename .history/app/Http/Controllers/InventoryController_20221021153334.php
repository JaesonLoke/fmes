...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        //s&d
        $sdsum = Report::whereMonth('created_at', '=', Carbon::now())->where('category','Shortage & Delay')->count() ;
        
        $wastepercentage = $sdsum;
        ...
        return view('pages.inventory.inventory',compact('inventorys','sum','percentage','lastmonth','wastesum','wastepercentage','wastepercentage','performance'))->with('i',(request()->input('page',1)-1)*5);
