...
class HomeController extends Controller
{
    ...
    {
        $users = User::where('id',auth()->user()->id)->first()->value('id');
        ...
        return view('dashboard',compact('users','notifications','products','reports','labels', 'data','linelabels','linedata','avaibility','performance','quality','oee'))->with('i',(request()->input('page',1)-1)*5);
    }
}
