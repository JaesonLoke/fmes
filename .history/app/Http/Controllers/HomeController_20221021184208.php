...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $avaibilitycompare = $avaibilitylastmonth == 0 ? 0 : ($avaibilitythismonth - $avaibilitylastmonth)/ $avaibilitylastmonth;
        ...
        return view('dashboard',compact('products','reports','labels', 'data','avaibility',''))->with('i',(request()->input('page',1)-1)*5);
    }
}
