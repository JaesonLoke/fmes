...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $sum=(DB::table('notifications')->whereMonth('created_at', '=', Carbon::now())->sum('quantity') + DB::table('reports')->whereMonth('created_at', '=', Carbon::now())->sum('wastedquantity'));
    
        $lastmonth = DB::table('notifications')->whereMonth('created_at', '=', Carbon::now()->subMonth()->format('m'))->sum('quantity') + DB::table('reports')->whereMonth('created_at', '=', Carbon::now()->subMonth()->format('m'))->sum('wastedquantity');
        ...
        return view('pages.inventory.inventory',compact('inventorys','sum','percentage','lastmonth'))->with('i',(request()->input('page',1)-1)*5);
