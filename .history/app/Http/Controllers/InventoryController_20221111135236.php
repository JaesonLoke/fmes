...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        ->sum('quantity') + Report::whereMonth('created_at', '=', Carbon::now()->subMonth()->format('m'))->sum('wastedquantity');
        ...
        //waste 
        $wastesum = $sum == 0 ? 0 : Report::whereMonth('created_at', '=', Carbon::now())->sum('wastedquantity') / $sum ;
