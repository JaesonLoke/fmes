...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $sdpercentage = $sdlastmonth == 0 ? 0 : ($sdthismonth - $sdlastmonth)/ $sdlastmonth;
        ...
        return view('pages.inventory.inventory',compact('inventorys','sum','percentage','lastmonth','wastesum','wastepercentage','sdpercentage','performance'))->with('i',(request()->input('page',1)-1)*5);
