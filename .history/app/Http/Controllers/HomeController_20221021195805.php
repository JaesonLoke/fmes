...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        //performance
        $performancethismonth = Product::where('created_at', '<', Carbon::now())->orWhere('created_at', '=', Carbon::now())->whereMonth('created_at', '=', Carbon::now())->count();
        $performanceslastmonth = Product::where('status','Running')->whereMonth('created_at', '=', Carbon::now())->count();
