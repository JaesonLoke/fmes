...
class UserController extends Controller
{
    ...
    {
        $admins = User::latest()->where('role','1')->simplePaginate(5);
        $users = User::latest()->where('role','0')->simplePaginate(5);
        ...
        return view('users.adduser',compact('percentage','thismonth','performance','admins'));
    }
