...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $inventory->fullname = $request->fullname;
        $inventory->name = $request->username;
        $inventory->email = $request->email;
        $inventory->contactnum = $request->phonenum;
        $inventory->pos = $request->fullname;
        $inventory->username = $request->name;
